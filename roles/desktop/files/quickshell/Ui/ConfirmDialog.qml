          ...
          Repeater {
            ...
            BorderSurface {
              ...
              Text {
                ...
                color: optionDelegate.destructive ? (optionDelegate.selected ? Color.urgent : root.foreground) : (optionDelegate.selected ? root.selectedText : root.foreground)
                font.family: root.fontFamily
              ...
              MouseArea {
                ...
                onEntered: root.selectedIndex = optionDelegate.index
                onClicked: {
                  if (optionDelegate.index === 0) root.canceled()
                  else root.confirmed()
                }
              }
            }
