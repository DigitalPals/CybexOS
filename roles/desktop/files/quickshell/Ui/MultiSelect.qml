...
Item {
  id: root
  readonly property var popupWindow: root.QsWindow.window
  ...
  Column {
    ...
    BorderSurface {
      ...
      QQC.Popup {
        ...
        parent: root.popupWindow ? root.popupWindow.contentItem : trigger
          ...
          Item {
            ...
            ListView {
              ...
              delegate: Rectangle {
                ...
                color: optionDelegate.index === resultList.currentIndex
                  ? Style.hoverFillFor(root.foreground, root.accent)
                  : "transparent"
                ...
                Row {
                  ...
                  BorderSurface {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    color: optionDelegate.selected ? Style.selectedFillFor(root.foreground, root.accent) : "transparent"
                    borderSpec: optionDelegate.selected
                ...
                MouseArea {
                  ...
                  onClicked: root.toggleValue(optionDelegate.modelData.value)
                }
              }
            }
          }
