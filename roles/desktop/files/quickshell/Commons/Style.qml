// Adapted from Omarchy; see ../compat/omarchy/README.md.
pragma Singleton
import QtQuick
import Quickshell
...
QtObject {
  ...
  property string fontFamily: Host.Theme.fontMenu

  // The concrete family `monospace` resolves to right now, e.g.
  // a configured monospace family. Bind `font.family` to `fontFamily` (so the
